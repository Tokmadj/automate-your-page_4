...
TITLE: Functions
Description:Functions are unique to coding, especially to Python because of the time and effect it has to programming. A function is a block of organized, reusable code that is used to perform a single, related action. They provide for a better modularity for your application and high degree of code reusing."""
